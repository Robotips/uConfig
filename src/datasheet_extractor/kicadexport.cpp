...
bool KicadExport::exportPack(Package *pack, QString fileName)
{
    ...
    // ==== header ====
    _out << "EESchema-LIBRARY Version 2.3  " << QDateTime::currentDateTime().toString("dd/MM/yyyy-hh:mm:ss") << endl;
    _out  << endl;
...
void KicadExport::exportPin(Pin pin, int x, int y, int orientation)
{
    ...
    switch (orientation)
    {
        case 0: orientation_str = "R"; break;
        case 1: orientation_str = "U"; break;
        case 2: orientation_str = "L"; break;
        case 3: orientation_str = "D"; break;
        default: break;
    }

    _out  << "X " << pin.name << " " << pin.pin << " " << x << " " << y << " 300 " << orientation_str << " 50 50 1 1 I" << endl;
}
